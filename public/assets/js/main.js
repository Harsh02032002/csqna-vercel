...
(function($) {
    ...
    ================-------------------*/
        ...
        if (document.getElementById("instragramslider_active")) {
            let getInstraDtata = document.getElementById("instragramslider_active")
            let getuserid = getInstraDtata.getAttribute("data-instra-id");
            let gettoken = getInstraDtata.getAttribute("data-instra-token");

            var feedFooter = new Instafeed({
                get: 'user',
                userId: getuserid, // your user id
                accessToken: gettoken, // your access token
                sortBy: 'most-liked',
    ...
    ================-------------------*/
        ...
        $(".rt-sidnav, .rt-cart-box").overlayScrollbars({
